...
def main(args=None):
    ...
    # Prepare goal poses
    goal_pose = []
    goal_pose.append(navigator.getPoseStamped([-1.26, 2.38], TurtleBot4Directions.EAST))
    goal_pose.append(navigator.getPoseStamped([-2.18, 3.6], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-3.46, 5.63], TurtleBot4Directions.NORTH_WEST))
